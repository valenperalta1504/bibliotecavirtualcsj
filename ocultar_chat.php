...
$result = $stmt->get_result();
    ...
    $query_actualizar = "UPDATE habilitar_registro SET Estado = '$mostrar' WHERE id = 2";
    mysqli_query($conn, $query_actualizar);
    }
    else {
    // Actualizar la contraseña en la base de datos
    $query_actualizar = "UPDATE habilitar_registro SET Estado = '$ocultar' WHERE id = 2";
    mysqli_query($conn, $query_actualizar);    
    }
    sleep(1);
    exit();
