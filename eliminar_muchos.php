...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["eliminar_muchos"]) && $_POST["eliminar_muchos"] === "eliminar_muchos") {
    $_SESSION["registros_seleccionados"] = $_POST["seleccionado"];

    foreach ($_POST["seleccionado"] as $id) {
        echo $id;
    } 
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["accion"]) && $_POST["accion"] === "confirmar") {
    session_start();
    $registrosSeleccionados = $_SESSION["registros_seleccionados"];
    ...
    foreach ($registrosSeleccionados as $id) {
