...
<li>
<p class="titulo2">MIS RESERVACIONES:</p>
<?php //Mostrar msj de error
                if (isset($error)) {
                    echo $error;}
            ?>
          <p>Cantidad: <?php echo $cantidad_libros_reservados;//Muestra cantidad de libros reservados ?></p>
            <?php
              echo $mis_reservaciones_final //Muestra los titulos y fechas reservadas
            ?>
</li>
</div>
      </ul>
