...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["banear"]) && $_POST["banear"] === "banear") {
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["accion"]) && $_POST["accion"] === "confirmar") {
    ...
    global $conn;
    session_start();
$id = $_SESSION['banear_usuario'];

unset($_SESSION['banear_usuario']);

// Using prepared statement to avoid SQL injection
$query = "UPDATE registro SET Ban = 'ban' WHERE id = $id";
$result = mysqli_query($conn, $query);
