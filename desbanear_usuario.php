...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["desbanear"]) && $_POST["desbanear"] === "desbanear") {
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["accion"]) && $_POST["accion"] === "confirmar") {
    ...
    session_start();
$id = $_SESSION['desbanear_usuario'];

unset($_SESSION['desbanear_usuario']);

// Using prepared statement to avoid SQL injection
$query = "UPDATE registro SET Ban = 'desban' WHERE id = $id";
$result = mysqli_query($conn, $query);
