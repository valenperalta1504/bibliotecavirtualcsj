...
// verificar si hay ventana emergente
require_once 'verificar_registro.php';
?>
...
<body>
    <div class="container">
		<nav>
			<ul>
				...
				<li><a href="registrarse.php"class="active">Registrarse</a></li>
			</ul>
		</nav>
    <header>
    ...
    <br><br>
            ...
            <button class="botón" type="submit" name="registrarse" value="registrarse">Registrarse</button>
        </form>
    </div>
    <footer>
